...
public class BotService {
    ...
    public void computeNextPlayerAction(PlayerAction playerAction) {
        ...
        if(!this.gameState.getGameObjects().isEmpty()){
            ...
            */
            if(getDistanceBetween(this.bot, gasList.get(0)) - this.bot.getSize() - gasList.get(0).getSize() < 100 || getDistanceBetween(this.bot, astList.get(0)) - this.bot.getSize() - astList.get(0).getSize() < 100 ) {
            ...
            if(getDistanceBetween(this.bot, enemyList.get(0))- this.bot.getSize() - enemyList.get(0).getSize() <= 200) {
                ...
                if(enemyList.get(0).getSize() < this.bot.getSize()) {
                    ...
                    if(this.bot.getSize() > 70 && getDistanceBetween(enemyList.get(0), bot) - this.bot.getSize() - enemyList.get(0).getSize() < 50) {
            ...
            if(torpedoList.size() > 0){
                System.out.println("TORPEDO HEADING: " + ((torpedoList.get(0).currentHeading + 180) % 360));
                System.out.println("PLAYER AND TORPEDO HEADING: " + getHeadingBetween(torpedoList.get(0)));
                if((getHeadingBetween(torpedoList.get(0)) + 180)%360 == torpedoList.get(0).currentHeading && getDistanceBetween(torpedoList.get(0), bot) < 150)
                {
