            ...
            if(!turn){
                ...
                */
                ...
                if(getDistanceBetween(bot, friendlyObjects.get(0)) < 5){
                    if(friendlyObjects.get(0).getGameObjectType() == ObjectTypes.WORMHOLE && friendlyObjects.get(0).size < bot.getSize()){
                ...
                */
                ...
                if(jarakKePusat + (0.5 * bot.getSize()) == jarakObjKePusat){
                    ...
                    playerAction.heading = (playerAction.heading + 45) % 360;
                    turn = true;
                    System.out.println("Turn on flag");
                }
            }else{
